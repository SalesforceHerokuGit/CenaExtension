...
// Required init:
// 		UX_stats.init('UA-84668833-2',chrome.runtime.id);
// Or if you want to hardcode extension ID:
// 		UX_stats.init('UA-84668833-2','mjegpgbaajnjofacpokbnmomgoeejmaob')
// Send stats about monetization installation
// 		UX_stats.monetization.install('v0')